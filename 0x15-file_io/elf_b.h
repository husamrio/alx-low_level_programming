...
* @e_ident: Array containing the ELF version.(Pointer)
*/
...
/**
* print_abi - ELF header ABI version(Prints)
...
/**
* print_type - ELF header type (Prints)
* @e_type: ELF type.
* @e_ident:Array containing the ELF class.(Pointer)
*/
